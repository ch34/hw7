...
ActiveRecord::Schema.define(version: 20170817195514) do
  ...
  create_table "tags_todoitems", id: false, force: :cascade do |t|
    ...
    t.index ["tag_id"], name: "index_tags_todoitems_on_tag_id"
    t.index ["todoitem_id"], name: "index_tags_todoitems_on_todoitem_id"
  end
  ...
  create_table "todoitems", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_todoitems_on_user_id"
  end
