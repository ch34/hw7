...
class TodoitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todoitem" do
    assert_difference('Todoitem.count') do
      post todoitems_url, params: { todoitem: { description: @todoitem.description, done: @todoitem.done, due_date: @todoitem.due_date, task_title: @todoitem.task_title } }
    end
  ...
  test "should update todoitem" do
    patch todoitem_url(@todoitem), params: { todoitem: { description: @todoitem.description, done: @todoitem.done, due_date: @todoitem.due_date, task_title: @todoitem.task_title } }
